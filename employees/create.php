...
$stmt = $db->prepare("INSERT INTO employees (first_name, middle_name, last_name, email, rfc, imss,phone_number, mobile_number, emergency_phone_number, emergency_contact) VALUES  (?,?,?,?,?,?,?,?,?,?)");
